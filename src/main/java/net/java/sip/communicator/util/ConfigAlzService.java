...
//        );
    ...
    private boolean isPinnedToTaskBar()
    {
...
//            fontDisabledProp, defaultValue);
     ...
     * - return FALSE.
     */
    public boolean isAutoPopupNewMessage()
    {
     ...
     **/
    public void setAutoPopupNewMessage(boolean autoPopup)
    {
...
//                    "no");
     ...
     * FALSE.
     */
    public boolean isCallPanelShown()
    {
     ...
     */
    public boolean isMinimizeInsteadOfHide()
    {
     ...
     *            <tt>false</tt> otherwise
     */
    public void setIsMinimizeInsteadOfHide(boolean value)
    {
...
//            "net.java.sip.communicator.impl.gui.minimizeInsteadOfHide", value);
     ...
     * dialog should be shown when user clicks on the X button.
     */
    public boolean isQuitWarningShown()
    {
     ...
     * return FALSE.
     */
    public boolean isSendTypingNotifications()
    {
     ...
     */
    public void setSendTypingNotifications(boolean isSendTypingNotif)
    {
...
//                Boolean.toString(isSendTypingNotif));
     ...
     */
    public boolean isMoveContactConfirmationRequested()
    {
     ...
     */
    public boolean isMultiChatWindowEnabled()
    {
     ...
     * property is true, otherwise - returns <code>false</code>.
     */
    public boolean isPrivateMessagingInChatRoomDisabled()
    {
     ...
     */
    public void setMultiChatWindowEnabled(boolean isEnabled)
    {
...
//            Boolean.toString(isMultiChatWindowEnabled));
     ...
     * property is true, otherwise - returns <code>false</code>.
     */
    public boolean isLeaveChatRoomOnWindowCloseEnabled()
    {
     ...
     */
    public void setLeaveChatRoomOnWindowClose(boolean isLeave)
    {
...
//            MessageHistoryService.PNAME_IS_MESSAGE_HISTORY_ENABLED, true);
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isRecentMessagesShown()
    {
     ...
     */
    public void setHistoryShown(boolean isShown)
    {
...
//            Boolean.toString(isHistoryShown));
     ...
     */
    public void setRecentMessagesShown(boolean isShown)
    {
...
//            Boolean.toString(!isRecentMessagesShown));
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isChatToolbarVisible()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isChatStylebarVisible()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isChatSimpleThemeEnabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isMergeContactDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isCreateGroupDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isFlattenGroupEnabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isGoToChatroomDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isRemoveContactDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isContactMoveDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isContactRenameDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isGroupRemoveDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isGroupRenameDisabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isPresetStatusMessagesEnabled()
    {
     ...
     * true, otherwise - returns <code>false</code>.
     */
    public boolean isAdvancedAccountConfigDisabled()
    {
     ...
     * <tt>false</tt> - otherwise
     */
    public boolean isChatRoomConfigDisabled()
    {
     ...
     */
    public String getChatDefaultFontFamily()
    {
     ...
     */
    public int getChatDefaultFontSize()
    {
     ...
     */
    public Color getChatDefaultFontColor()
    {
     ...
     */
    public boolean isChatFontItalic()
    {
     ...
     */
    public boolean isChatFontUnderline()
    {
     ...
     */
    public void setAdvancedAccountConfigDisabled(boolean disabled)
    {
...
//                Boolean.toString(isAdvancedAccountConfigDisabled));
     ...
     */
    public String getSendMessageCommand()
    {
     ...
     */
    public void setSendMessageCommand(String newMessageCommand)
    {
...
//                newMessageCommand);
     ...
     */
    public String getLastContactParent()
    {
     ...
     */
    public ProtocolProviderService getLastCallConferenceProvider()
    {
...
//            "net.java.sip.communicator.impl.gui.call.lastCallConferenceProvider"));
     ...
     * <tt>accountId</tt>
     */
    private ProtocolProviderService findProviderFromAccountId(
...
//                    = UtilActivator.bundleContext.getService(serRef);
     ...
     * enabled.
     */
    public void setChatHistorySize(int historySize)
    {
...
//            Integer.toString(chatHistorySize));
     ...
     */
    public int getChatWriteAreaSize()
    {
     ...
     * <code>false</code> otherwise.
     */
    public boolean isTransparentWindowEnabled()
    {
     ...
     */
    public String getSendFileLastDir()
    {
     ...
     * <code>false</code> otherwise.
     */
    public boolean isNormalizePhoneNumber()
    {
     ...
     */
    public void setNormalizePhoneNumber(boolean isNormalize)
    {
...
//            Boolean.toString(isNormalize));
     ...
     * <code>false</code> otherwise.
     */
    public boolean isAlerterEnabled()
    {
     ...
     */
    public void setAlerterEnabled(boolean isEnabled)
    {
...
//            Boolean.toString(isEnabled));
     ...
     * be considered as a phone number.  <code>false</code> otherwise.
     */
    public boolean acceptPhoneNumberWithAlphaChars()
    {
     ...
     */
    public void setAcceptPhoneNumberWithAlphaChars(boolean accept)
    {
...
//                Boolean.toString(acceptPhoneNumberWithAlphaChars));
     ...
     * chat history area, <code>false</code> otherwise.
     */
    public boolean isShowStatusChangedInChat()
    {
     ...
     * to route video calls and desktop sharing through it.
     */
    public boolean isRouteVideoAndDesktopUsingPhoneNumberEnabled()
    {
     ...
     * account is available.
     */
    public boolean isHideAccountSelectionWhenPossibleEnabled()
    {
     ...
     */
    public boolean isHideAccountStatusSelectorsEnabled()
    {
     ...
     */
    public boolean isHideExtendedAwayStatus()
    {
     ...
     * is disabled.
     */
    public boolean isAutoAnswerDisableSubmenu()
    {
     ...
     * <tt>false</tt> - otherwise
     */
    public boolean isSingleWindowInterfaceEnabled()
    {
     ...
     */
    public boolean isHideAddressInCallHistoryTooltipEnabled()
    {
     ...
     */
    public boolean isSmsNotifyTextDisabled()
    {
     ...
     */
    public boolean isHideDomainInReceivedCallDialogEnabled()
    {
     ...
     */
    public void setSingleWindowInterfaceEnabled(boolean isEnabled)
    {
...
//                Boolean.toString(isCallPanelShown));
     ...
     */
    public void setApplicationVisible(boolean isVisible)
    {
...
//                Boolean.toString(isVisible));
     ...
     * shown again.
     */
    public void setQuitWarningShown(boolean isWarningShown)
    {
...
//                Boolean.toString(isQuitWarningShown));
     ...
     */
    public void setPopupHandlerConfig(String handler)
    {
        //TODO DEVTE-1304 fix me for GUI
//        configService.setProperty("systray.POPUP_HANDLER", handler);
     ...
     * last contact
     */
    public void setLastContactParent(String groupName)
    {
...
//                groupName);
     ...
     */
    public void setMoveContactConfirmationRequested(boolean isRequested)
    {
...
//            Boolean.toString(isMoveContactConfirmationRequested));
     ...
     * application.
     */
    public void setTransparentWindowEnabled(boolean isTransparent)
    {
...
//                Boolean.toString(isTransparentWindowEnabled));
     ...
     */
    public void setChatToolbarVisible(boolean isVisible)
    {
...
//                Boolean.toString(isChatToolbarVisible));
     ...
     */
    public void setShowSmileys(boolean isVisible)
    {
...
//                Boolean.toString(isShowSmileys));
     ...
     */
    public void setChatSimpleThemeEnabled(boolean isEnabled)
    {
...
//                Boolean.toString(isChatSimpleThemeEnabled));
     ...
     */
    public void setChatStylebarVisible(boolean isVisible)
    {
...
//                Boolean.toString(isChatStylebarVisible));
     ...
     */
    public void setChatWriteAreaSize(int size)
    {
...
//                Integer.toString(chatWriteAreaSize));
     ...
     */
    public void setSendFileLastDir(String lastDir)
    {
...
//            lastDir);
     ...
     * conference call
     */
    public void setLastCallConferenceProvider(
...
//            protocolProvider.getAccountID().getAccountUniqueID());
     ...
     */
    public void setChatDefaultFontFamily(String fontFamily)
    {
...
//            fontFamily);
     ...
     */
    public void setChatDefaultFontSize(int fontSize)
    {
...
//            fontSize);
     ...
     */
    public void setChatFontIsBold(boolean isBold)
    {
...
//            isBold);
     ...
     */
    public void setChatFontIsItalic(boolean isItalic)
    {
...
//            isItalic);
     ...
     */
    public void setChatFontIsUnderline(boolean isUnderline)
    {
...
//            isUnderline);
     ...
     */
    public void setChatDefaultFontColor(Color fontColor)
    {
...
//            (country.length() > 0) ? (language + '_' + country) : language);
     ...
     */
    public void saveChatRoom(  ProtocolProviderService protocolProvider,
...
//        }
     ...
     */
    public void updateChatRoomProperty(
            ProtocolProviderService protocolProvider,
            String chatRoomId,
            String property,
            String value)
...
//        }
     ...
     * <tt>ConfigurationService</tt>.
     */
    public String getChatRoomProperty(
        ProtocolProviderService protocolProvider,
        String chatRoomId,
        String property)
    {
...
//        }
     ...
     */
    public String getChatRoomPrefix(String accountID, String chatRoomId)
    {
        String prefix = "net.java.sip.communicator.impl.gui.accounts";
        //TODO DEVTE-1304 fix me for GUI
//        List<String> accounts = configService
...
//        }
     ...
     */
    public void setContactListGroupCollapsed(String groupID,
                                                    boolean isCollapsed)
    {
...
//        }
     ...
     * or <tt>false</tt> otherwise
     */
    public boolean isContactListGroupCollapsed(String groupID)
    {
        String prefix = "net.java.sip.communicator.impl.gui.contactlist.groups";
...
//        }
     ...
     */
    public boolean isShowAccountConfig()
    {
...
//            port);
     ...
     */
    public int getClientSecurePort()
    {
        //TODO DEVTE-1304 fix me for GUI
//        return configService.getInt(
...
//            5061);
     ...
     * @param port the port to set
     */
    public void setClientSecurePort(int port)
    {
        //TODO DEVTE-1304 fix me for GUI
//        configService.setProperty(
//            ProtocolProviderFactory.PREFERRED_SECURE_PORT_PROPERTY_NAME,
...
//        return enabledSslProtocols.split("(,)|(,\\s)");
     ...
     */
    public String[] getAvailableSslProtocols()
    {
        SSLSocket temp;
        try
        {
     ...
     */
    public void setEnabledSslProtocols(String[] enabledProtocols)
    {
        //TODO DEVTE-1304 fix me for GUI
...
//        }
     ...
     * configuration, <tt>false</tt> otherwise.
     */
    public boolean hasEnabledVideoFormat(
            ProtocolProviderService protocolProvider)
    {
