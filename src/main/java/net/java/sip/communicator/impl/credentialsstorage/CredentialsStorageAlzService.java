 ...
 */
public class CredentialsStorageAlzService
    implements CredentialsStorageService
{
    ...
    private final Logger logger
        = Logger.getLogger(CredentialsStorageAlzService.class);
     ...
     * @see CredentialsStorageAlzService#storePassword(String, String)
     */
     ...
     * @see CredentialsStorageAlzService#createCrypto()
     */
