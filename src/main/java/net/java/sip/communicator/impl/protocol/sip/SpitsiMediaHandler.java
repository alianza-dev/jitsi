 ...
 */
public class SpitsiMediaHandler extends CallPeerMediaHandlerSipImpl {
    /**
    ...
    private static final Logger logger
        = Logger.getLogger(SpitsiMediaHandler.class);
     ...
     * managing media for.
     */
    public SpitsiMediaHandler(CallPeerSipImpl peer)
    {
        super(peer);
                   ...
                   IllegalArgumentException
    {
        /*
                ...
                Header contentTypeHeader = ack.getHeader(RFC3261.HDR_CONTENT_TYPE);
                byte[] offerBytes = ack.getRawContent();

                if (offerBytes != null
                        && contentTypeHeader != null
                        //TODO dubious... must test
                        && contentTypeHeader.toString().contains(RFC3261.CONTENT_TYPE_SDP)) {
